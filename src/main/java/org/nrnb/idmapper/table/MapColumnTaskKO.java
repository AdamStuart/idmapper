package org.nrnb.idmapper.table;
...
public class MapColumnTaskKO extends AbstractTableColumnTask {
	...
	MapColumnTaskKO(final UndoSupport undoSupport, final CyColumn column) {
		super(column);
	}
	...
	public ListSingleSelection<String> source_selection = new ListSingleSelection<String>(KOIdMapper.SYMBOL,
			KOIdMapper.GENE_ID, KOIdMapper.ENSEMBL, KOIdMapper.UniProtKB_AC, KOIdMapper.UniProtKB_ID);
	...
	public ListSingleSelection<String> target_selection = new ListSingleSelection<String>(KOIdMapper.SYMBOL,
			KOIdMapper.GENE_ID, KOIdMapper.ENSEMBL, KOIdMapper.SYNONYMS, KOIdMapper.UniProtKB_AC,
			KOIdMapper.UniProtKB_ID, KOIdMapper.RefSeq, KOIdMapper.GI, KOIdMapper.PDB, KOIdMapper.GO,
			KOIdMapper.UniRef100, KOIdMapper.UniRef90, KOIdMapper.UniRef50, KOIdMapper.UniParc, KOIdMapper.PIR,
			KOIdMapper.EMBL);
	...
	public ListSingleSelection<String> species_selection = new ListSingleSelection<String>(KOIdMapper.HUMAN,
			KOIdMapper.MOUSE, KOIdMapper.FLY, KOIdMapper.YEAST);
	...
	public void run(final TaskMonitor taskMonitor) {
		...
		new_column_name = MappingUtil.makeNewColumnName(target, source, new_column_name, column);
